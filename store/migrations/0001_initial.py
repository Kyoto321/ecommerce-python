# Generated by Django 4.2.4 on 2023-09-02 20:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('waitingapproval', 'Waiting approval'), ('active', 'Active'), ('delected', 'Deleted')], default='active', max_length=50)),
